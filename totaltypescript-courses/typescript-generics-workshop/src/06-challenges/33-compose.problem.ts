...
function compose<T1, T2, T3>(func: (t1: T1) => T2, func2: (t2: T2) => T3): (t1: T1) => T3
function compose<T1, T2, T3, T4>(func: (t1: T1) => T2, func2: (t2: T2) => T3, func3: (t3: T3) => T4): (t1: T1) => T4
function compose<T1, T2, T3, T4, T5>(func: (t1: T1) => T2, func2: (t2: T2) => T3, func3: (t3: T3) => T4, func4: (t4: T4) => T5): (t1: T1) => T5
